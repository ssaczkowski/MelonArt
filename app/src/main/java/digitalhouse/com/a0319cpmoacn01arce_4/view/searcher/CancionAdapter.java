...
public class CancionAdapter extends RecyclerView.Adapter implements Filterable {
        ...
        public CancionViewHolder(@NonNull View itemView,final OnItemSelectedListener onItemSelectedListener) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                        ...
                        Data dataConLista = new Data(listaDeCanciones);

                        onItemSelectedListener.onItemClick(listaDeCanciones.get(getAdapterPosition()),dataConLista,getAdapterPosition());
    ...
    public interface OnItemSelectedListener {
        void onItemClick(Cancion cancion, Data dataConLista, Integer posicion);
    }
